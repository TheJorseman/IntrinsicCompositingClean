...
from intrinsic_compositing_clean.altered_midas.dpt_depth import DPTDepthModel
...
from intrinsic_compositing_clean.altered_midas.transforms import Resize, NormalizeImage, PrepareForNet
