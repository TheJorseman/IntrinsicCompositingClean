...
from intrinsic_compositing_clean.boosted_depth.utils import ImageandPatchs, ImageDataset, generatemask, getGF_fromintegral, calculateprocessingres, rgb2gray,\
    applyGridpatch

# MIDAS
#import intrinsic_compositing_clean.boosted_depth.midas.utils
from intrinsic_compositing_clean.boosted_depth.midas.models.midas_net import MidasNet
from intrinsic_compositing_clean.boosted_depth.midas.models.transforms import Resize, NormalizeImage, PrepareForNet

# PIX2PIX : MERGE NET
#from intrinsic_compositing_clean.boosted_depth.pix2pix.options.test_options import TestOptions
...
def create_depth_models(device='cuda', midas_path=None, pix2pix_path=None):
    ...
    if pix2pix_path == None:
        pix2pixmodel.save_dir = f'{curr_path}/intrinsic_compositing_clean.boosted_depth/pix2pix/checkpoints/mergemodel'
    else:
    ...
    if midas_path == None:
        midas_model_path = f"{curr_path}/intrinsic_compositing_clean.boosted_depth/midas/model.pt"
    else:
