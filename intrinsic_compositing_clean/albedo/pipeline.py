...
from intrinsic_compositing_clean.lib.general import np_to_pil

from .model.editingnetwork_trainer import EditingNetworkTrainer
...
def load_albedo_harmonizer(checkpoint_load_path, device="cpu"):
    ...
    args.batch_size = 1
    args.checkpoint_load_path = checkpoint_load_path
